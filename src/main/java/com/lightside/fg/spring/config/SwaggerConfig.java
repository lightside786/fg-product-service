package com.lightside.fg.spring.config;
...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    static final String title = "ButterKnife Service Rest APIs";
    ...
    @Bean
    public Docket butterKnifeApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("butterknife")
                .apiInfo(getApiInfo())
                .select()
                .paths(regex("/api/v1.*"))
                .build()
    ...
    private List<ResponseMessage> getDefaultResponseMessages() {
        ...
        defaultResponseMessages.add(new ResponseMessageBuilder()
                ...
                .responseModel(new ModelRef("ApiResponse")).build());
        defaultResponseMessages.add(new ResponseMessageBuilder()
